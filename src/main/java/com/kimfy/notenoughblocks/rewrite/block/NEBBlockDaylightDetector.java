...
public class NEBBlockDaylightDetector extends BlockDaylightDetector implements IBlockProperties
{
    private final Material material;
    
    public NEBBlockDaylightDetector(Material material, List<JsonBlock> data)
    {
        super();
    ...
    {
        return side == 1 ? icons[0][1] : icons[0][0];
    }
