...
{
    public NEBBlockPressurePlate(Material material, List<JsonBlock> data)
    {
        super(null, material, data.get(0).getObjectSensitivity() != null ? data.get(0).getObjectSensitivity() : BlockPressurePlate.Sensitivity.everything);
        this.data = data;
    }
