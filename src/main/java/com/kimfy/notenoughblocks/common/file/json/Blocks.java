...
public class Blocks
{
    ...
    public static void loadBlocks()
    {
        ...
        blockList.add(tmp = new BlockJson().displayName("Dandelion").shape("flower").hardness(0.0F).stepSound("grass").textures("all: flower_dandelion"));
        blockList.add(new BlockJson().displayName("Poppy").parent(tmp).textures("all: flower_rose"));
        blockList.add(new BlockJson().displayName("Blue Orchid").parent(tmp).textures("all: flower_blue_orchid"));
        blockList.add(new BlockJson().displayName("Allium").parent(tmp).textures("all: flower_allium"));
        blockList.add(new BlockJson().displayName("Azure Bluet").parent(tmp).textures("all: flower_houstonia"));
        blockList.add(new BlockJson().displayName("Red Tulip").parent(tmp).textures("all: flower_tulip_red"));
        blockList.add(new BlockJson().displayName("Orange Tulip").parent(tmp).textures("all: flower_tulip_orange"));
        blockList.add(new BlockJson().displayName("White Tulip").parent(tmp).textures("all: flower_tulip_white"));
        blockList.add(new BlockJson().displayName("Pink Tulip").parent(tmp).textures("all: flower_tulip_pink"));
        blockList.add(new BlockJson().displayName("Oxeye Daisy").parent(tmp).textures("all: flower_oxeye_daisy"));
