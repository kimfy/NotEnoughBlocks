...
import com.kimfy.notenoughblocks.rewrite.client.renderer.RenderBlockPane;
import com.kimfy.notenoughblocks.rewrite.client.renderer.RenderBlockStainedGlassPane;
...
{
    public NEBBlockPane(Material material, List<JsonBlock> data)
    {
        super(null, null, material, false);
        this.data = data;
    }
    ...
    {
        if (this.isBlockStained())
        {
            return RenderBlockStainedGlassPane.blockPaneRenderId;
        }
        else
        {
            return RenderBlockPane.blockPaneRenderId;
        }
    }
    ...
    {
        return side == 0 ? icons[meta][0] : icons[meta][1];
    }
    ...
    {
        this.icons = new IIcon[this.textures.length][2]; // 0 = face. 1 = top texture
