...
import com.kimfy.notenoughblocks.rewrite.client.renderer.RenderBlockLilyPad;
...
public class NEBBlockLilyPad extends BlockLilyPad implements IBlockProperties
{
    public NEBBlockLilyPad(Material material, List<JsonBlock> data)
    {
        super();
        float f = 0.5F;
        float f1 = 0.015625F;
    ...
    {
        return RenderBlockLilyPad.renderBlockLilyPadId;
    }
    ...
    {
        return meta <= this.subBlocks ? icons[meta][0] : icons[0][0];
    }
